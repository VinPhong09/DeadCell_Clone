...
public class Boss_Run6_50 : StateMachineBehaviour
{
    Transform player;
    Rigidbody2D rb;
    ...
    public float timedelay2 = 3f;
    public float timeatk3 = 0f;
    public float timedelay3 = 1f;
    public float timeatk4 = 0f;
    public float timedelay4 = 3f;
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        if (Vector2.Distance(player.position,rb.position) <= attackSkill4)
        {
            c.randomNum = Random.value;
