...
public class MentalCharController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            timeCool1 = Time.timeSinceLevelLoad + cooldown1;
        }
        if (!hasUsedSkill2)
        {
            canUseSkill2 = true;
        ...
        {
            timeCool2 = Time.timeSinceLevelLoad + cooldown2;
        }
        if (!hasUsedSkill3)
        {
            canUseSkill3 = true;
        ...
        {
            timeCool3 = Time.timeSinceLevelLoad + cooldown3;
        }
    ...
    public void Attack()
    {
        if (Input.GetMouseButtonDown(0) && m_timeSinceAttack > 0.4f && !isRoll)
        {
